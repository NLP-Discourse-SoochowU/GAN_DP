# -*- coding: utf-8 -*-
"""
Since I had done many different experiments based on this project, some model settings below could be useless.
Longyin Zhang
"""
...
USE_BOUND, USE_GAN, USE_S_STACK = True, False, False

WARM_UP_EP = 7 if USE_GAN else 20
MAX_W, MAX_H = 80, 20
LEARN_RATE, WD, D_LR = 0.001, 1e-4, 0.0001
EPOCH, BATCH_SIZE, LOG_EVERY, VALIDATE_EVERY = 20, 5, 1, 5
in_channel_G, out_channel_G, ker_h_G, ker_w_G, strip_G = 2, 8, 3, MAX_W, 1
p_w_G, p_h_G = 3, 1
METype = 1
USE_AE = False
TRAIN_Ext = False
...
USE_POSE, POS_SIZE = True, 30
USE_ELMo, EMBED_LEARN = True, False
EMBED_SIZE, HIDDEN_SIZE = (1024 if USE_ELMo else 300), 256
